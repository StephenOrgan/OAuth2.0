...
item_delete = Blueprint("item_delete", __name__, template_folder="../templates")
...
def deleteItem(category_id, item_id):
  ...
  if request.method == 'POST':
    ...
    return redirect(url_for('itemforcategory.showItemsByCategory', category_id = category_id))
  else:
