...
from flask import Flask, flash, make_response, Blueprint, request
from flask import redirect, url_for, session as login_session

TEMPLDIR = "../templates"
NAME = "linkedin_login"

linkedin_login = Blueprint(NAME, __name__, template_folder=TEMPLDIR)
...
def linkedincallback():
    """
    Gathers data from LinkedIn Sign In API and places it inside a
    session variable.
    """
...
def lidisconnect():
    """
    Delete's linkedin's session variables and returns appropriate response
    """
